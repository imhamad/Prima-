			...
			<div class="pathwell_about_header">
				...
				<h1 class="pathwell_about_title"><?php
					...
					echo esc_html(sprintf(__('Welcome to %1$s %2$s v.%3$s', 'pathwell'),
								$theme->name,
								PATHWELL_THEME_FREE ?esc_html__('Free', 'pathwell') : '',
								$theme->version
								));
				?></h1>
						...
						<table class="pathwell_about_table" cellpadding="0" cellspacing="0" border="0">
							...
							<tbody>
								...
								<tr>
									<td class="pathwell_about_table_info">
										<h2 class="pathwell_about_table_info_title">
											<?php esc_html_e('WPBakery Page Builder', 'pathwell'); ?>
										</h2>
										<div class="pathwell_about_table_info_description"><?php
											esc_html_e('Full integration with a very popular page builder "WPBakery Page Builder". A number of useful shortcodes and widgets to create beautiful homepages and other sections of your website.', 'pathwell');
										?></div>
									</td>
									<td class="pathwell_about_table_check"><i class="dashicons dashicons-no"></i></td>
									<td class="pathwell_about_table_check"><i class="dashicons dashicons-yes"></i></td>
								...
								<tr>
									<td class="pathwell_about_table_info">
										...
										<div class="pathwell_about_table_info_description"><?php
											esc_html_e('A number of useful shortcodes to create beautiful homepages and other sections of your website with WPBakery Page Builder.', 'pathwell');
										?></div>
									</td>
									<td class="pathwell_about_table_check"><i class="dashicons dashicons-no"></i></td>
									<td class="pathwell_about_table_check"><i class="dashicons dashicons-yes"></i></td>
