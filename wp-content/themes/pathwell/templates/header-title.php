						...
						?><div class="sc_layouts_title_title"><?php
							...
							<h1 itemprop="headline" class="sc_layouts_title_caption<?php echo esc_attr($pathwell_blog_title_class); ?>"><?php
								...
								if (!empty($pathwell_top_icon)) {
									...
									?><img src="<?php echo esc_url($pathwell_top_icon); ?>" alt="<?php esc_attr__('image', 'pathwell'); ?>" <?php if (!empty($pathwell_attr[3])) pathwell_show_layout($pathwell_attr[3]);?>><?php
								}
								echo wp_kses_post($pathwell_blog_title_text);
							?></h1>
							<?php
