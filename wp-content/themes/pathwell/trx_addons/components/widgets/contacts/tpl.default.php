	...
	if (!empty($address) || !empty($phone) || !empty($email)) {
		?><div class="contacts_info"><?php
			if (!empty($address)) {
				...
				?><span class="contacts_address"><label><?php esc_html_e( 'Address:', 'pathwell' ); ?></label><span><?php echo str_replace('|', "<br>", $address); ?></span></span><?php
				if ($columns) {
					?></div><?php
				}
			}
			if (!empty($phone) || !empty($email)) {
				...
				if (!empty($email)) {
					?><span class="contacts_email"><label><?php esc_html_e( 'Email:', 'pathwell' ); ?></label><a href="mailto:<?php echo antispambot($email); ?>"><?php echo antispambot($email); ?></a></span><?php
				}
				if (!empty($phone)) {
					?><span class="contacts_phone"><label><?php esc_html_e( 'Phone:', 'pathwell' ); ?></label><a href="<?php echo esc_attr(trx_addons_get_phone_link($phone)); ?>"><?php echo wp_kses_data($phone); ?></a></span><?php
				}
				if ($columns) {
					?></div><?php
				}
